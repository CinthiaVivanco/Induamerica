          ...
          <div class="col-sm-6">        
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-3 control-label">Nacionalidad <span class="required">*</span></label>
                <div class="col-sm-7">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-3 control-label">Estado Civil <span class="required">*</span></label>
                <div class="col-sm-7">
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="panel-body">
                ...
                <div class="form-group">
                     <label class="col-sm-3 control-label">Tipo Trabajador <span class="required">*</span></label>
                      <div class="col-sm-7">
                ...
                <div class="form-group">
                     <label class="col-sm-3 control-label">Regimen Laboral <span class="required">*</span></label>
                      <div class="col-sm-7">
                ...
                <div class="form-group">
                     <label class="col-sm-3 control-label">Categoria Ocupacional <span class="required">*</span></label>
                      <div class="col-sm-7">
                ...
                <div class="form-group">
                     <label class="col-sm-3 control-label">Ocupacion <span class="required">*</span></label>
                      <div class="col-sm-7">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">¿Discapacitado? <span class="required">*</span></label>
                    <div class="col-sm-7">
                      <div class="be-radio has-success inline">
          ...
          <div class="col-sm-6">
                ...
                <div class="panel-body">
                   ...
                   <div class="form-group">
                      <label class="col-sm-3 control-label">¿Sindicalizado? <span class="required">*</span></label>
                      <div class="col-sm-7">
                        <div class="be-radio has-success inline">
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-3 control-label">Situación Especial <span class="required">*</span></label>
                      <div class="col-sm-7">
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-3 control-label">Local <span class="required">*</span></label>
                      <div class="col-sm-7">
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-3 control-label">Motivo Baja <span class="required">*</span></label>
                      <div class="col-sm-7">
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-3 control-label">Entidad Financiera <span class="required">*</span></label>
                      <div class="col-sm-7">
          ...
          <div class="col-md-12">
              ...
              <div class="panel-body">
                  ...
                  <div class="form-group">
                      ...
                      <label class="col-sm-3 control-label">Nivel Instruccion <span class="required">*</span></label>
                      <div class="col-sm-5">
                  ...
                  <div class="form-group">
                    <label class="col-sm-3 control-label">¿Estudios en Perú?</label>
                    <div class="col-sm-5">
                      <div class="be-radio has-success inline">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-3 control-label">Regimen Institucion</label>
                <div class="col-sm-5">
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label">Año Egreso </label>
                <div class="col-sm-5">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="form-group">
                        <label class="col-sm-3 control-label">Referencia <span class="required">*</span></label>
                        <div class="col-sm-7">
                      ...
                      <div class="form-group">
                        <label class="col-sm-3 control-label">Domiciliado <span class="required">*</span></label>
                        <div class="col-sm-7">
                          <div class="be-radio has-success inline">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-3 control-label">Tipo Pago <span class="required">*</span></label>
                                <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                  <label class="col-sm-3 control-label">Número Cuenta <span class="required">*</span></label>
                                  <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                  <label class="col-sm-3 control-label">Remuneración <span class="required">*</span></label>
                                  <div class="col-sm-7">
        ...
        <div class="row">
              ...
              <div class="col-sm-6">
                <div class="panel-body">
                     ...
                     <div class="form-group">
                          ...
                          <label class="col-sm-3 control-label">Regimen Salud <span class="required">*</span></label>
                          <div class="col-sm-7">
                     ...
                     <div class="form-group">
                          ...
                          <label class="col-sm-3 control-label">Regimen Pensionario <span class="required">*</span> </label>
                          <div class="col-sm-7">
                      ...
                      <div class="form-group">
                          <label class="col-sm-3 control-label">CUSSP </label>
                          <div class="col-sm-7">
                      ...
                      <div class="form-group">
                          <label class="col-sm-3 control-label">ESSALUD <span class="required">*</span></label>
                          <div class="col-sm-7">
                            <div class="be-radio has-success inline">
                      ...
                      <div class="form-group">
                        <label class="col-sm-3 control-label">SENATI <span class="required">*</span></label>
                        <div class="col-sm-7">
                          <div class="be-radio has-success inline">
                      ...
                      <div class="form-group">
                        <label class="col-sm-3 control-label">SCTR Salud <span class="required">*</span></label>
                        <div class="col-sm-7">
                          <div class="be-radio has-success inline">
                      ...
                      <div class="form-group">
                        <label class="col-sm-3 control-label">SCTR Pensiones <span class="required">*</span></label>
                        <div class="col-sm-7">
                          <div class="be-radio has-success inline">
              ...
              <div class="col-sm-6">
                  ...
                  <div class="panel-body">
                          ...
                          <div class="form-group">
                                <label class="col-sm-3 control-label">¿Afiliado a EPS? <span class="required">*</span></label>
                                <div class="col-sm-7">
                                  <div class="be-radio has-success inline">
                          ...
                          <div class="form-group">
                                ...
                                <label class="col-sm-3 control-label">EPS <span class="required">*</span></label>
                                <div class="col-sm-7">
                          ...
                          <div class="form-group">
                              <label class="col-sm-3 control-label grande" >¿Otros ingresos?</label>
                          ...
                          <div class="form-group">
                            <label class="col-sm-3 control-label">¿5ta Exonerada?</label>
                            <div class="col-sm-7">
                              <div class="be-radio has-success inline">
                          ...
                          <div class="form-group">
                            <label class="col-sm-3 control-label">¿Asignación Familiar? <span class="required">*</span></label>
                            <div class="col-sm-7">
                              <div class="be-radio has-success inline">
                          ...
                          <div class="form-group">
                              <label class="col-sm-3 control-label">Activo <span class="required">*</span></label>
                              <div class="col-sm-7">
                                <div class="be-radio has-success inline">
